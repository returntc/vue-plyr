...
var sharedStore$1 = store$3;var functionToString$1 = Function.toString; // this helper broken in `core-js@3.4.1-3.4.4`, so we can't use `shared` helper
...
var inspectSource$1 = sharedStore$1.inspectSource;var WeakMap$4 = global_1$1.WeakMap;
var nativeWeakMap$1 = typeof WeakMap$4 === 'function' && /native code/.test(inspectSource$1(WeakMap$4));var isPure$1 = false;var shared$1 = createCommonjsModule$1(function (module) {
...
};var hiddenKeys$3 = {};var OBJECT_ALREADY_INITIALIZED = 'Object already initialized';
...
});var path$1 = global_1$1;var aFunction$3 = function (variable) {
...
var toLength$1 = function (argument) {
  return argument > 0 ? min$8(toInteger$1(argument), 0x1FFFFFFFFFFFFF) : 0; // 2 ** 53 - 1 == 9007199254740991
};var max$5 = Math.max;
...
var enumBugKeys$1 = ['constructor', 'hasOwnProperty', 'isPrototypeOf', 'propertyIsEnumerable', 'toLocaleString', 'toString', 'valueOf'];var hiddenKeys$2 = enumBugKeys$1.concat('length', 'prototype'); // `Object.getOwnPropertyNames` method
...
var objectGetOwnPropertySymbols$1 = {
  f: f$7
};var ownKeys$3 = getBuiltIn$1('Reflect', 'ownKeys') || function ownKeys(it) {
...
var isForced_1$1 = isForced$1;var getOwnPropertyDescriptor$4 = objectGetOwnPropertyDescriptor$1.f;
/*
...
var f$6 = function getOwnPropertyNames(it) {
  return windowNames && toString$1.call(it) == '[object Window]' ? getWindowNames(it) : $getOwnPropertyNames$1(toIndexedObject$1(it));
};
...
var defineWellKnownSymbol = function (NAME) {
  ...
  if (!has$3(Symbol, NAME)) defineProperty$8(Symbol, NAME, {
...
var setToStringTag$1 = function (it, TAG, STATIC) {
  if (it && !has$3(it = STATIC ? it : it.prototype, TO_STRING_TAG$6)) {
    defineProperty$7(it, TO_STRING_TAG$6, {
      configurable: true,
      value: TAG
    });
  }
...
if (!nativeSymbol$1) {
  $Symbol = function Symbol() {
    ...
    if (descriptors$1 && USE_SETTER) setSymbolDescriptor(ObjectPrototype$2, tag, {
      configurable: true,
      set: setter
    });
  ...
  if (descriptors$1) {
    ...
    {
      redefine$1(ObjectPrototype$2, 'propertyIsEnumerable', $propertyIsEnumerable$1, {
        unsafe: true
      });
    }
  }
...
hiddenKeys$3[HIDDEN] = true;var SPECIES$5 = wellKnownSymbol$1('species');
...
var toStringTagSupport$1 = String(test$2) === '[object z]';var TO_STRING_TAG$4 = wellKnownSymbol$1('toStringTag'); // ES3 wrong here
...
var objectToString = toStringTagSupport$1 ? {}.toString : function toString() {
...
defineWellKnownSymbol('iterator');var createMethod$4 = function (CONVERT_TO_STRING) {
...
if (!has$3(IteratorPrototype$5, ITERATOR$d)) {
...
}() : undefined);var IteratorPrototype$3 = iteratorsCore$1.IteratorPrototype;
...
var getInternalState$3 = internalState$1.getterFor(STRING_ITERATOR$1); // `String.prototype[@@iterator]` method
...
addToUnscopables$1('entries');var ITERATOR$b = wellKnownSymbol$1('iterator');
...
for (var COLLECTION_NAME in domIterables) {
  ...
  if (CollectionPrototype) {
    ...
    if (CollectionPrototype[ITERATOR$b] !== ArrayValues) try {
      createNonEnumerableProperty$1(CollectionPrototype, ITERATOR$b, ArrayValues);
    } catch (error) {
      CollectionPrototype[ITERATOR$b] = ArrayValues;
    }
...
var regexpExec$1 = patchedExec$1;// https://tc39.es/ecma262/#sec-regexp.prototype.exec
...
};var SPECIES$2 = wellKnownSymbol$1('species'); // `SpeciesConstructor` abstract operation
// https://tc39.es/ecma262/#sec-speciesconstructor

var speciesConstructor = function (O, defaultConstructor) {
  var C = anObject$1(O).constructor;
  var S;
  return C === undefined || (S = anObject$1(C)[SPECIES$2]) == undefined ? defaultConstructor : aFunction$2(S);
...
fixRegexpWellKnownSymbolLogic$1('split', 2, function (SPLIT, nativeSplit, maybeCallNative) {
  ...
  function (regexp, limit) {
    ...
    while (q < S.length) {
      ...
      if (z === null || (e = min$6(toLength$1(splitter.lastIndex + (UNSUPPORTED_Y$4 ? q : 0)), S.length)) === p) {
...
}, UNSUPPORTED_Y$4);var TO_STRING = 'toString';
...
var SUBSTITUTION_SYMBOLS_NO_NAMED$1 = /\$([$&'`]|\d{1,2})/g; // `GetSubstitution` abstract operation
...
var getSubstitution$1 = function (matched, str, position, captures, namedCaptures, replacement) {
  ...
  return replace$3.call(replacement, symbols, function (match, ch) {
    var capture;
...
fixRegexpWellKnownSymbolLogic$1('replace', 2, function (REPLACE, nativeReplace, maybeCallNative, reason) {
  ...
  typeof (NewTarget = dummy.constructor) == 'function' && NewTarget !== Wrapper && isObject$3(NewTargetPrototype = NewTarget.prototype) && NewTargetPrototype !== Wrapper.prototype) objectSetPrototypeOf$1($this, NewTargetPrototype);
  return $this;
...
var FORCED$2 = descriptors$1 && isForced_1$1('RegExp', !CORRECT_NEW || UNSUPPORTED_Y$3 || fails$1(function () {
...
setSpecies('RegExp');fixRegexpWellKnownSymbolLogic$1('match', 1, function (MATCH, nativeMatch, maybeCallNative) {
...
});var UNSUPPORTED_Y$2 = regexpStickyHelpers$1.UNSUPPORTED_Y; // `RegExp.prototype.flags` getter
// https://tc39.es/ecma262/#sec-get-regexp.prototype.flags
// eslint-disable-next-line es/no-regexp-prototype-flags -- required for testing

if (descriptors$1 && (/./g.flags != 'g' || UNSUPPORTED_Y$2)) {
...
var nativeUrl$1 = !fails$1(function () {
  ...
  return isPure$1 && !url.toJSON || !searchParams.sort || url.href !== 'http://a/c%20d?a=1&c=3' || searchParams.get('c') !== '3' || String(new URLSearchParams('?a=1')) !== 'a=1' || !searchParams[ITERATOR$7] // throws in Edge
...
var objectAssign$1 = !$assign$1 || fails$1(function () {
  ...
  if (descriptors$1 && $assign$1({
    b: 1
  }, $assign$1(defineProperty$3({}, 'a', {
    enumerable: true,
    get: function () {
  ...
  return T;
} : $assign$1;var maxInt$1 = 2147483647; // aka. 0x7FFFFFFF or 2^31-1
...
var adapt$1 = function (delta, numPoints, firstTime) {
  var k = 0;
  delta = firstTime ? floor$8(delta / damp$1) : delta >> 1;
  delta += floor$8(delta / numPoints);

  for (; delta > baseMinusTMin$1 * tMax$1 >> 1; k += base$1) {
    delta = floor$8(delta / baseMinusTMin$1);
  }

  return floor$8(k + (baseMinusTMin$1 + 1) * delta / (delta + skew$1));
};
/**
...
var encode$1 = function (input) {
  ...
  while (handledCPCount < inputLength) {
    ...
    if (m - n > floor$8((maxInt$1 - delta) / handledCPCountPlusOne)) {
...
/* init */
{
  ...
  if (init !== undefined) {
    if (isObject$3(init)) {
      ...
      } else for (key in init) if (has$3(init, key)) entries.push({
        key: key,
        value: init[key] + ''
      });
    } else {
...
redefine$1(URLSearchParamsPrototype$1, ITERATOR$6, URLSearchParamsPrototype$1.entries); // `URLSearchParams.prototype.toString` method
    ...
    switch (state) {
      ...
      case SCHEME$1:
        if (char && (ALPHANUMERIC$1.test(char) || char == '+' || char == '-' || char == '.')) {
          ...
          if (stateOverride && (isSpecial$1(url) != has$3(specialSchemes$1, buffer) || buffer == 'file' && (includesCredentials$1(url) || url.port !== null) || url.scheme == 'file' && !url.host)) return;
          url.scheme = buffer;
...
if (descriptors$1) {
  objectDefineProperties$1(URLPrototype$1, {
    ...
    host: accessorDescriptor$1(getHost$2, function (host) {
      var url = getInternalURLState$1(this);
...
var arraySort = mergeSort;var firefox = engineUserAgent$1.match(/firefox\/(\d+)/i);
var engineFfVersion = !!firefox && +firefox[1];var engineIsIeOrEdge = /MSIE|Trident/.test(engineUserAgent$1);var webkit = engineUserAgent$1.match(/AppleWebKit\/(\d+)\./);
var engineWebkitVersion = !!webkit && +webkit[1];var test$1 = [];
...
_export$1({
  ...
  /* , ...items */
    ...
    if (argumentsLength === 0) {
      ...
      actualDeleteCount = min$4(max$2(toInteger$1(deleteCount), 0), len - actualStart);
    }
...
addToUnscopables$1('includes');var notARegexp = function (it) {
  if (isRegexp(it)) {
...
if (isForced_1$1(NUMBER, !NativeNumber(' 0o1') || !NativeNumber('0b1') || NativeNumber('+0x1'))) {
  ...
  for (var keys$1 = descriptors$1 ? getOwnPropertyNames(NativeNumber) : ( // ES3:
  ...
  'fromString,range').split(','), j = 0, key; keys$1.length > j; j++) {
    if (has$3(NativeNumber, key = keys$1[j]) && !has$3(NumberWrapper, key)) {
...
var FORCED = nativeToFixed && (0.00008.toFixed(3) !== '0.000' || 0.9.toFixed(0) !== '1' || 1.255.toFixed(2) !== '1.25' || 1000000000000000128.0.toFixed(0) !== '1000000000000000128') || !fails$1(function () {
  // V8 ~ Android 4.3-
  nativeToFixed.call({});
...
});var getOwnPropertyDescriptor$2 = objectGetOwnPropertyDescriptor$1.f; // eslint-disable-next-line es/no-string-prototype-startswith -- safe
...
addToUnscopables$1(FIND);var propertyIsEnumerable = objectPropertyIsEnumerable$1.f; // `Object.{ entries, values }` methods implementation
...
addToUnscopables$1(FIND_INDEX);var _excluded = ["premium", "referrerPolicy"];
...
var vimeo = {
  ...
  ready: function ready() {
    ...
    var premium = config.premium,
        ...
        frameParams = _objectWithoutProperties(config, _excluded); // If the owner has a pro or premium account then we can hide controls etc
    ...
    var params = buildUrlParams(_objectSpread2$1({
